...
colorA_t textureClouds_t::getColor(const point3d_t &p, float dSdx, float dTdx, float dSdy, float dTdy, bool from_postprocessed) const
{
...
colorA_t textureMarble_t::getColor(const point3d_t &p, float dSdx, float dTdx, float dSdy, float dTdy, bool from_postprocessed) const
{
	if(!color_ramp) return applyColorAdjustments(color1 + getFloat(p)*(color2 - color1));
	else return applyColorAdjustments(color_ramp->get_color_interpolated(getFloat(p)));
}
...
colorA_t textureWood_t::getColor(const point3d_t &p, float dSdx, float dTdx, float dSdy, float dTdy, bool from_postprocessed) const
{
	if(!color_ramp) return applyColorAdjustments(color1 + getFloat(p)*(color2 - color1));
	else return applyColorAdjustments(color_ramp->get_color_interpolated(getFloat(p)));
}
...
colorA_t rgbCube_t::getColor(const point3d_t &p, float dSdx, float dTdx, float dSdy, float dTdy, bool from_postprocessed) const
{
...
colorA_t textureVoronoi_t::getColor(const point3d_t &p, float dSdx, float dTdx, float dSdy, float dTdy, bool from_postprocessed) const
{
	float da[4];
	point3d_t pa[4];
	vGen.getFeatures(p*size, da, pa);
...
colorA_t textureMusgrave_t::getColor(const point3d_t &p, float dSdx, float dTdx, float dSdy, float dTdy, bool from_postprocessed) const
{
	if(!color_ramp) return applyColorAdjustments(color1 + getFloat(p)*(color2 - color1));
	else return applyColorAdjustments(color_ramp->get_color_interpolated(getFloat(p)));
}
...
colorA_t textureDistortedNoise_t::getColor(const point3d_t &p, float dSdx, float dTdx, float dSdy, float dTdy, bool from_postprocessed) const
{
	if(!color_ramp) return applyColorAdjustments(color1 + getFloat(p)*(color2 - color1));
	else return applyColorAdjustments(color_ramp->get_color_interpolated(getFloat(p)));
}
...
colorA_t textureBlend_t::getColor(const point3d_t &p, float dSdx, float dTdx, float dSdy, float dTdy, bool from_postprocessed) const
{
